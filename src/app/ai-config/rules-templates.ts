...
`;
  ...
  } else if (activeFileCheck === "skills/vulnerability-scanner/SKILL.md") {
    if (isVi) {
      content = `---
...
`;
  } else if (activeFileCheck === "workflows/feat.md") {
    content = `---
...
`;
  } else if (activeFileCheck === "workflows/refactor.md") {
    content = `---
...
`;
  } else if (activeFileCheck === "workflows/plan.md") {
    content = `---
...
\`\`\`
`;
  } else if (activeFileCheck === "workflows/ui-ux.md") {
    content = `---
