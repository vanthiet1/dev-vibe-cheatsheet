export function getGeoFundamentalsTemplate(
  ...
  return metadata + `# GEO Fundamentals
...
- **File Path**: \`.agent/skills/geo-fundamentals/scripts/geo_checker.py\`
- **Execution Command**: \`python .agent/skills/geo-fundamentals/scripts/geo_checker.py <project_path>\`
