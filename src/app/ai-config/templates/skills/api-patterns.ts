export function getApiPatternsTemplate(
...
- **File Path**: \`.agent/skills/api-patterns/scripts/api_validator.py\`
- **Execution Command**: \`python .agent/skills/api-patterns/scripts/api_validator.py <project_path>\`
