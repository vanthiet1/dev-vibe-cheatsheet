export function getMobileDesignTemplate(
  ...
  return metadata + `# Mobile Design System
...
- **File Path**: \`.agent/skills/mobile-design/scripts/mobile_audit.py\`
- **Execution Command**: \`python .agent/skills/mobile-design/scripts/mobile_audit.py <project_path>\`
