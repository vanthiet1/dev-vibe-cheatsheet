export function getDatabaseDesignTemplate(
  ...
  return metadata + `# Database Design
...
- **File Path**: \`.agent/skills/database-design/scripts/schema_validator.py\`
- **Execution Command**: \`python .agent/skills/database-design/scripts/schema_validator.py <project_path>\`
